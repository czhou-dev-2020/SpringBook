...
// comment added by crane zhou on 2021.11.03
//

public class ExtendedAuthUsers extends AuthUsers implements UserDetails, CredentialsContainer {
...
//    private static final Log logger = LogFactory.getLog(User.class);
    ...
    private final AuthUsers m_objAuthUser;

    /**
     * Calls the more complex constructor with all boolean arguments set to {@code true}.
     */
    public ExtendedAuthUsers(String username, String password, Collection<? extends GrantedAuthority> authorities, AuthUsers objAuthUsers) {
        this(username, password, true, true, true, true, authorities, objAuthUsers);
    }
     ...
     */
    public ExtendedAuthUsers(String username, String password, boolean enabled, boolean accountNonExpired,
                             boolean credentialsNonExpired, boolean accountNonLocked,
                             Collection<? extends GrantedAuthority> authorities, AuthUsers objAuthUser) {
        ...
        this.m_objAuthUser = objAuthUser;
    }

    // added by crane zhou on 2021.11.03
    public AuthUsers getAuthUsers() { return this.m_objAuthUser; }
//    public void setAuthUsers(AuthUsers objTheAuthUsers) { this.m_objAuthUsers = objTheAuthUsers; }
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ExtendedAuthUsers) {
            return this.username.equals(((ExtendedAuthUsers) obj).username);
        }
        return false;
    }
...
//        private static final long serialVersionUID = SpringSecurityCoreVersion.SERIAL_VERSION_UID;
    ...
    public static final class UserBuilder {
        ...
        // added by crane zhou on 2021.11.03
        private AuthUsers m_objAuthUser;
        ...
        // added by crane zhou on 2021.11.03
        public UserBuilder setupAuthUsers(AuthUsers objAuthUser) {
            this.m_objAuthUser = objAuthUser;
            return this;
        }
        ...
        public UserDetails build() {
            ...
            return new ExtendedAuthUsers(this.username, encodedPassword, !this.disabled, !this.accountExpired,
                    !this.credentialsExpired, !this.accountLocked, this.authorities, this.m_objAuthUser);
        }
    }
}
