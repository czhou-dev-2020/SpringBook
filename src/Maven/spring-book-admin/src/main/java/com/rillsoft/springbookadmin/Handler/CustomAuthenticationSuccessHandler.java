...
public class CustomAuthenticationSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
    ...
    private final GrantedAuthority m_objAdminAuthority = new SimpleGrantedAuthority(
            "ADMIN");
//            "ROLE_ADMIN");
...
//            String targetUrl="/admin/users";
            String targetUrl="/admin/groups";
            ...
            if ( !StringUtils.hasLength(targetUrl) || targetUrl.equals("/")) {
//                targetUrl= "/account/home";
    ...
    protected boolean isAdminAuthority(final Authentication authentication)
    {
        return CollectionUtils.isNotEmpty(authentication.getAuthorities())
                && authentication.getAuthorities().contains(m_objAdminAuthority);
    }
}
